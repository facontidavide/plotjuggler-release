...
kiss_fftndr_cfg KISS_FFT_API kiss_fftndr_alloc(const int* dims, int ndims,
                                               int inverse_fft, void* mem,
                                               size_t* lenmem);
/*
 dims[0] must be even
...
void KISS_FFT_API kiss_fftndr(kiss_fftndr_cfg cfg, const kiss_fft_scalar* timedata,
...
void KISS_FFT_API kiss_fftndri(kiss_fftndr_cfg cfg, const kiss_fft_cpx* freqdata,
