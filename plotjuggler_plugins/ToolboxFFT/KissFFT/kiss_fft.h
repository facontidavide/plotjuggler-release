...
kiss_fft_cfg KISS_FFT_API kiss_fft_alloc(int nfft, int inverse_fft, void* mem,
                                         size_t* lenmem);
 ...
 * */
void KISS_FFT_API kiss_fft_stride(kiss_fft_cfg cfg, const kiss_fft_cpx* fin,
...
/*
 Cleans up some memory that gets managed internally. Not necessary to call, but it might
 clean up your compiler output to call this before you exit.
*/
