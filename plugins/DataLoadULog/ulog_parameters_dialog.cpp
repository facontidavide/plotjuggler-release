...
ULogParametersDialog::ULogParametersDialog(const ULogParser &parser,
                                           QWidget *parent):
    QDialog(parent),
    ui(new Ui::ULogParametersDialog)
{
    ...
    for(const auto& log_msg: parser.getLogs() )
    {
        ...
        {
        case '0': table_logs->setItem( row, 1, new QTableWidgetItem("EMERGENCY") ); break;
        case '1': table_logs->setItem( row, 1, new QTableWidgetItem("ALERT") ); break;
        case '2': table_logs->setItem( row, 1, new QTableWidgetItem("CRITICAL") ); break;
        case '3': table_logs->setItem( row, 1, new QTableWidgetItem("ERROR") ); break;
        case '4': table_logs->setItem( row, 1, new QTableWidgetItem("WARNING") ); break;
        case '5': table_logs->setItem( row, 1, new QTableWidgetItem("NOTICE") ); break;
        case '6': table_logs->setItem( row, 1, new QTableWidgetItem("INFO") ); break;
        case '7': table_logs->setItem( row, 1, new QTableWidgetItem("DEBUG") ); break;
        default:
